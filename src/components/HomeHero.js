...
const NewsHero = () => {
  ...
  const images = [
    { url: "https://tinyurl.com/agriimg01", caption: "Agriculture News" },
    { url: "https://tinyurl.com/agriimg02", caption: "Crop Recommendor System" },
    { url: "https://tinyurl.com/agriimg03", caption: "AI Crop Imaging" },
  ];
